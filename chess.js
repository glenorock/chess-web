window.onload = function(){
    ...
    //defines the icons on each square
    for(var n = 0; n < 64; n++){
        if(values[n] !== 0){
    ...
    function updateSquarecolor(){ // defines the color of the board
        for(var n = 0; n < 64; n++){
            if(Math.floor(n/8)%2 === 0){
                if(n%2 === 0){
                    sqs[n].style.background = '#fffdd0';
                }
                else {
                    sqs[n].style.background = '#a0522d';
                }
            }
            else {
                if(n%2 === 1){
